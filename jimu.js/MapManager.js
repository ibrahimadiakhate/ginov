...
define([
  ...
  LayerInfos, Message, AppStatePopup, MapUrlParamsHandler, AppStateManager, PopupManager, FilterManager, ConfigLoader, portalUtils) {
  var instance = null,
    clazz = declare(null, {
      appConfig: null,
      mapDivId: '',
      ...
      showMap: function() {
        ...
        if(this.appConfig.map.webmap) {
          var deferred = this._queryWebmapByName(this.appConfig.map.webmap, this.appConfig);
          deferred.then(lang.hitch(this, function(result) {
            dojo.some(result.results, lang.hitch(this, function(result){
              if(result.type === "Web Map") {
                this.appConfig.map.itemId = result.id;
                return true; 
              }
            }));
            this._showMap(this.appConfig);
      ...
      initLayersParam: function(map) {
        this.configLoader = ConfigLoader.getInstance2();
        this.configLoader.initLayers(map);
      },
      ...
      _queryWebmapByName: function(name, appConfig) {
