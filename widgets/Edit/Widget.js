      ...
      ****************************************/
      ...
      _autoApplyEditWhenGeometryIsModified: function (/*graphicMoveStopEvent*/) {
        ...
        //   graphicMoveStopEvent.target._modified) {
          this._updateSelectedFeature(selectedFeature);//bha modif
        if (this._configEditor.autoApplyEditWhenGeometryIsMoved) {
      ...
      _onEditorPopupShow: function () {
        ...
        //bha modif
        //var id_anomalie = currentFeature.attributes.globalid;
        //var inp = document.getElementsByClassName("dijitInputInner")[0];
        //mettre a jour id_anomalie
        for(i=0; i<currentFeature._layer.graphics.length;i++){
          currentFeature._layer.graphics[i].attributes.id_anomalie = currentFeature._layer.graphics[i].attributes.globalid;
        }
