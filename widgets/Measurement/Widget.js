        ...
        this._processConfig(json).then(lang.hitch(this, function(measurementJson) {
          ...
          this.own(aspect.after(this.measurement, 'setTool', lang.hitch(this, function() {
            if (this.measurement.activeTool) {
              ...
              domClass.remove("use_mesure", "hidden-label-mesure");
            } else {
              this.enableWebMapPopup();
              domClass.add("use_mesure", "hidden-label-mesure"); 
            }
          })));

          this.measurement.startup();
		  //bha modif
		  this.measurement._distanceUnitStrings = ["Kilomètres", "Mètres"];
          this.measurement._distanceUnitStringsLong = ["esriKilometers", "esriMeters"];
		  this.measurement._areaUnitStrings = ["Acres", "Kilomètres carrés", "Hectares", "Mètres carrés"];
          this.measurement._areaUnitStringsLong = ["esriAcres", "esriSquareKilometers", "esriHectares", "esriSquareMeters"];
		  //bha fin modif
