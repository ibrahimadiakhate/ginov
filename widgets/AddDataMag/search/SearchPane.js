...
define(["dojo/_base/declare",
  ...
  function(declare, lang, array, on, domClass, _WidgetBase, _TemplatedMixin,
    _WidgetsInTemplateMixin, template, i18n, request, ioQuery) {
    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
      ...
      search: function() {
		...
		if(portal.credential && portal.credential.token){
			queryStr = queryStr + "&token=" + portal.credential.token;
		}
		...
		this._dfd = dfd = request(url_rqt_mag , params).then(function(data){
